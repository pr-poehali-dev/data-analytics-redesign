...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Переводы за секунды</h3>
      <p className="mb-4 text-sm text-gray-400">Отправляйте деньги клиентам, партнёрам и поставщикам мгновенно — без комиссий и очередей</p>
